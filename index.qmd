...
<div style="text-align: center;">
  <img src="images/my_cabbages.gif" alt="cabbage_man" loop="true" style="width: 80%;"/> 
</div>

If you could recognize this infamous cabbage man and his love for his cabbages, 
then it would be no surprise to you that the topic we chose to discuss was 
Avatar the Last Airbender. 

To keep it brief for those who don't know, Avatar the Last Airbender is a 
...
has caught many people's attention again. Thus, some questions that we are 
interested in studying are the following:   

1. How often does Aang speak in the show? What about each season? Do his 
friends, Katara, Sokka, Toph, and Zuko, begin to talk more than him? 

2. How often does each pair of main characters interact with each other? For 
instance, how often does Aang interact with Katara, Sokka, Toph, or Zuko 
throughout the show? What about the others? How often does Katara interact with 
Sokka, Toph, Zuko, etc?

3. Does a particular main character's appearance in the episode impact the IMDB 
Rating positively or negatively?

As for the reasons why we chose these types of questions, we did so for mainly 
two reasons: 

1. We were interested in whether this would change our perspective or provide 
new insight into our favorite characters from the show and

2. We hoped these questions would do the same for the show's large fanbase and 
new incoming watchers starting the show. 
